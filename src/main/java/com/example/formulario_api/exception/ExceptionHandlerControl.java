package com.example.formulario_api.exception;
...
public class ExceptionHandlerControl {
    ...
    public ResponseEntity<?> tratarErroDeIntegridadeEFaltaDeColuna(ValidacaoException ex){
        return ResponseEntity.badRequest().body("Está faltando informações na requisição, favor verificar");
    }
